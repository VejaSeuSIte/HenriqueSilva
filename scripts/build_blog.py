...
LANDINGS = {
    ...
    'civel': {
        'slug': 'civel',
        'nav': 'civel',
        'related_category': 'civel',
        'page_title': 'Advogado Cível em Pernambuco · Contratos, Indenizações e Responsabilidade Civil · Henrique Silva',
        'page_description': 'Atuação em Direito Cível: contratos, indenizações por dano moral e material, responsabilidade civil, cobranças e relações patrimoniais. Atendimento técnico em PE.',
        'eyebrow': 'Direito Cível',
        'h1': 'Direito <em>Cível</em> · contratos, indenizações e patrimônio.',
        'subtitle': 'Contratos, indenizações por dano moral e material, responsabilidade civil, cobranças e demais questões patrimoniais entre particulares e empresas.',
        'cta_text': 'Análise gratuita pelo WhatsApp',
        'wa_text': 'Olá, Dr. Henrique. Tenho uma questão cível e gostaria de conversar.',
        'intro': {
            'h2': 'Cível é a <em>espinha dorsal</em> do dia a dia jurídico.',
            'paragraphs': [
                'A maioria das relações jurídicas privadas — contratos, cobranças, danos, vizinhança, transporte, eventos — vive sob o guarda-chuva do <strong>Direito Cível</strong>. Lidar com essas situações sem advogado costuma sair caro: prazo perdido, cláusula mal interpretada, tese fraca.',
                'Atendemos com a mesma profundidade quem precisa <strong>cobrar</strong> e quem precisa se <strong>defender</strong>. Indenizações por evento mal entregue, contrato descumprido, dano moral em redes sociais, cobrança indevida — tudo passa por análise técnica antes de qualquer ação.',
                'A primeira conversa é <strong>gratuita</strong>. Você descreve o caso, eu indico se vale a pena agir, em que prazo e com que estratégia.',
            ],
        },
        'bullets_eye': 'O que conduzimos',
        'bullets_h2': 'Causas <em>cíveis</em> que atendemos.',
        'bullets': [
            {'title': 'Indenização por dano moral', 'text': 'Ofensas em redes sociais, exposição indevida, negativação injusta, falha em serviço com humilhação. Coleta de provas e fundamentação técnica.'},
            {'title': 'Indenização material', 'text': 'Reparação por prejuízos econômicos: produto danificado, evento não entregue, descumprimento contratual com perda concreta.'},
            {'title': 'Responsabilidade civil', 'text': 'Casos de acidentes de trânsito, queda em estabelecimentos, eventos com vítimas. Apuração de culpa e cálculo de indenização.'},
            {'title': 'Contratos', 'text': 'Análise prévia, redação, revisão e ações de cumprimento ou rescisão. Distratos, multas e clausulas abusivas.'},
            {'title': 'Cobrança e execução', 'text': 'Ações de cobrança de dívidas, monitória, execução de título extrajudicial e busca de bens do devedor.'},
            {'title': 'Vizinhança e propriedade', 'text': 'Conflitos com vizinhos (barulho, infiltração, ocupação), divisão de bens, inventário extrajudicial e regularização.'},
        ],
        'faq': [
            {'q': 'Em quanto tempo prescreve uma ação cível?', 'a': 'Depende do tipo. Indenização por dano moral/material: <strong>3 anos</strong>. Contrato: <strong>10 anos</strong>. Cobrança de aluguel: <strong>3 anos</strong>. Cheque: <strong>6 meses</strong>. Mande os detalhes que confirmamos antes da prescrição.'},
            {'q': 'Quanto custa contratar?', 'a': 'Combinamos por escrito antes de iniciar. Em ações de indenização e cobrança, é comum honorário misto: parte fixa + percentual sobre o que recuperar. Sem honorários ocultos.'},
            {'q': 'Tenho que ir à audiência?', 'a': 'Em geral sim, especialmente em audiência de conciliação. Hoje muitas Varas aceitam <strong>audiência virtual</strong>, o que facilita pra quem mora longe ou tem rotina apertada.'},
            {'q': 'Posso entrar com ação contra empresa grande?', 'a': 'Sim. As ações contra grandes empresas (telecom, banco, plano de saúde) têm jurisprudência estabilizada e vêm sendo julgadas em prol do consumidor/contratante. Conhecemos as teses recorrentes.'},
            {'q': 'Vale a pena processar por valor pequeno?', 'a': 'Para valores até <strong>40 salários mínimos</strong>, há os Juizados Especiais (gratuitos no primeiro grau). Para valores maiores, a Justiça Comum costuma valer a pena se o dano é claro. Avaliamos custo-benefício antes.'},
        ],
    },
    ...
    'consumidor': {
        'slug': 'consumidor',
        'nav': 'consumidor',
        'related_category': 'consumidor',
        'page_title': 'Advogado Direito do Consumidor em PE · Bancos, Saúde, Telefonia · Henrique Silva',
        'page_description': 'Defesa em relações de consumo: cobranças indevidas, bancos, planos de saúde, telefonia, vícios de produto e serviço. Indenizações e devolução em dobro pelo CDC.',
        'eyebrow': 'Direito do Consumidor',
        'h1': 'Direito do <em>Consumidor</em> · Código vigente desde 1990.',
        'subtitle': 'Defesa em relações de consumo: cobranças indevidas, bancos, planos de saúde, viagens, telefonia, e-commerce e vícios. Indenizações e devolução em dobro.',
        'cta_text': 'Análise gratuita pelo WhatsApp',
        'wa_text': 'Olá, Dr. Henrique. Tenho um problema de consumo e gostaria de conversar.',
        'intro': {
            'h2': 'O CDC é <em>uma das melhores leis</em> do Brasil — pouca gente usa.',
            'paragraphs': [
                'O <strong>Código de Defesa do Consumidor</strong> (Lei 8.078/1990) garante direitos que muita gente não conhece: devolução em dobro, inversão do ônus da prova, responsabilidade objetiva do fornecedor, multa por descumprimento. Tudo isso é regularmente esquecido por quem aceita o "fato consumado" da empresa.',
                'Atuamos em <strong>todas as frentes consumeristas</strong>: cobrança indevida, negativação injusta, plano de saúde com cobertura negada, atraso ou cancelamento de voo, falha de internet/celular, vício de produto, e-commerce que não entrega.',
                'A primeira análise é <strong>gratuita</strong>. Mande capturas, contratos e protocolos pelo WhatsApp.',
            ],
        },
        'bullets_eye': 'O que defendemos',
        'bullets_h2': 'Causas <em>consumeristas</em> mais comuns.',
        'bullets': [
            {'title': 'Bancos e financeiras', 'text': 'Cobrança indevida, débito não reconhecido, negativação injusta, juros abusivos em empréstimos consignados, golpes via Pix com responsabilidade do banco.'},
            {'title': 'Plano de saúde', 'text': 'Negativa de cobertura, reajuste abusivo de mensalidade, exigência de carência indevida, descredenciamento de hospital, demora na autorização.'},
            {'title': 'Companhias aéreas', 'text': 'Voo cancelado ou atrasado, overbooking, bagagem extraviada ou danificada. Indenizações por danos morais e materiais conforme STJ.'},
            {'title': 'Telefonia e internet', 'text': 'Cobrança por serviço não contratado, falha persistente sem reparo, fidelidade abusiva, mudança de plano sem autorização.'},
            {'title': 'E-commerce', 'text': 'Produto não entregue, vício oculto, recusa de troca em prazo legal, propaganda enganosa. Aplicação do direito de arrependimento (7 dias).'},
            {'title': 'Cobrança indevida', 'text': 'Devolução em <strong>dobro</strong> de valores cobrados a maior, taxas abusivas em contratos, multas indevidas.'},
        ],
        'faq': [
            {'q': 'Tenho 7 dias pra desistir de qualquer compra?', 'a': 'Apenas em compras feitas <strong>fora do estabelecimento</strong> — internet, telefone, catálogo. Compra presencial não tem direito de arrependimento (a menos que haja vício). O prazo conta da entrega, não da compra.'},
            {'q': 'Negativaram meu nome injustamente. Quanto recebo?', 'a': 'Indenização por dano moral em negativação indevida varia de <strong>R$ 5.000 a R$ 15.000</strong> em PE, conforme jurisprudência do TJPE. Acresce-se a baixa imediata da negativação e suspensão da cobrança.'},
            {'q': 'Plano de saúde negou meu tratamento. O que faço?', 'a': 'Se o tratamento tem indicação médica, a recusa é ilegal — a Súmula 102 do STJ é clara. Cabe <strong>liminar judicial</strong> em poucos dias para forçar autorização. Vale também indenização por dano moral.'},
            {'q': 'Voo atrasou 4 horas. Tenho direito?', 'a': 'Sim. Acima de 4 horas há direito a <strong>assistência material</strong> (alimentação, hospedagem) e indenização por dano moral em torno de <strong>R$ 3.000 a R$ 8.000</strong>, mais ressarcimento de despesas.'},
            {'q': 'Quanto custa um advogado de consumidor?', 'a': 'No Juizado Especial (até 40 SM), o primeiro grau é <strong>gratuito</strong> e advogado é facultativo até 20 SM. Atuamos com honorários por êxito: você só paga se ganhar, com percentual sobre a indenização.'},
        ],
    },
    ...
    'juizados': {
        'slug': 'juizados',
        'nav': 'juizados',
        'related_category': 'juizados',
        'page_title': 'Juizados Especiais em PE · Pequenas Causas · Henrique Silva Advocacia',
        'page_description': 'Ações cíveis até 40 salários mínimos nos Juizados Especiais: cobranças, pequenos litígios de consumo, indenizações e demandas de menor complexidade.',
        'eyebrow': 'Juizados Especiais Cíveis',
        'h1': 'Juizados <em>Especiais</em> · justiça rápida, custos baixos.',
        'subtitle': 'Ações cíveis até 40 salários mínimos: cobranças, pequenos litígios de consumo, indenizações e demandas de menor complexidade. Mais rápido que a Justiça Comum.',
        'cta_text': 'Análise gratuita pelo WhatsApp',
        'wa_text': 'Olá, Dr. Henrique. Tenho um caso para Juizado Especial.',
        'intro': {
            'h2': 'Juizado Especial é <em>processo civil simplificado</em>.',
            'paragraphs': [
                'Os <strong>Juizados Especiais Cíveis</strong> (Lei 9.099/95) foram criados para resolver litígios de menor complexidade com agilidade. Custos zero no primeiro grau, audiência única quando possível, e foco em <strong>conciliação</strong>. O resultado: causas que levariam 3 anos na Justiça Comum saem em 6 a 12 meses.',
                'Atendemos as duas frentes: <strong>autor</strong> (quem cobra ou pede indenização) e <strong>réu</strong> (defesa quando você é processado). Em ambos os casos, o conhecimento técnico das teses específicas do Juizado faz a diferença.',
                'A primeira análise é <strong>gratuita</strong>. Mande os documentos pelo WhatsApp.',
            ],
        },
        'bullets_eye': 'O que cobre',
        'bullets_h2': 'Quando usar o <em>Juizado Especial</em>.',
        'bullets': [
            {'title': 'Limite de valor', 'text': 'Causas até <strong>40 salários mínimos</strong>. Acima disso, vai pra Justiça Comum. Até 20 SM, você pode até ir sem advogado (mas é arriscado).'},
            {'title': 'Pequenas cobranças', 'text': 'Dívidas de até R$ 56 mil em 2026 (40 SM): cheques sem fundo, notas promissórias, alugueis vencidos, prestação de serviço não paga.'},
            {'title': 'Indenizações simples', 'text': 'Acidente de trânsito sem vítima, dano em produto, brigas de vizinhança, reembolso de evento cancelado.'},
            {'title': 'Consumidor de baixa monta', 'text': 'Pequenos problemas com bancos, telefonia, e-commerce. Cobrança indevida, multas abusivas, falha em serviço.'},
            {'title': 'Sem custos no 1º grau', 'text': 'No Juizado, <strong>não se paga custas</strong> em primeira instância. Em recurso, há custas. Sem honorários de sucumbência se você perder.'},
            {'title': 'Conciliação obrigatória', 'text': 'Toda audiência começa com tentativa de acordo. Se houver acordo, o caso encerra. Senão, prossegue para julgamento.'},
        ],
        'faq': [
            {'q': 'Posso ir sozinho ao Juizado?', 'a': 'Em causas até <strong>20 salários mínimos</strong>, advogado é facultativo. Acima disso, é obrigatório. Mesmo nos casos onde é facultativo, ter advogado aumenta muito a chance de êxito — o réu vem com advogado.'},
            {'q': 'Quanto tempo demora?', 'a': 'Em média <strong>6 a 12 meses</strong>. Audiência de conciliação acontece em 30-60 dias. Se houver acordo, encerra na hora. Senão, audiência de instrução em 60-90 dias e sentença logo depois.'},
            {'q': 'Quanto custa o advogado?', 'a': 'Trabalhamos com <strong>honorários por êxito</strong> em Juizado Especial: percentual sobre o que você receber. Sem custo inicial. Se perder, não paga honorários.'},
            {'q': 'Posso recorrer da sentença?', 'a': 'Sim, em 10 dias. Recurso vai para a <strong>Turma Recursal</strong> (não para o TJ). Acima dela, só Recurso Extraordinário ao STF em casos específicos.'},
            {'q': 'O réu pode parcelar a dívida?', 'a': 'Pode propor acordo de parcelamento na audiência. Se aceito, vira sentença homologatória e o credor recebe parceladamente. Se descumprir, retoma execução.'},
        ],
    },
    ...
    'criminal': {
        'slug': 'criminal',
        'nav': 'criminal',
        'related_category': 'criminal',
        'page_title': 'Advogado Criminal · Consultoria Estratégica · Henrique Silva Advocacia · OAB/PE 31.742',
        'page_description': 'Atuação seletiva em Direito Criminal mediante análise técnica criteriosa. Consultoria estratégica, com prioridade a clientes do escritório em outras áreas.',
        'eyebrow': 'Direito Criminal',
        'h1': 'Direito <em>Criminal</em> · atuação seletiva e estratégica.',
        'subtitle': 'Consultoria criminal mediante análise técnica criteriosa, com prioridade a clientes já integrados ao portfólio do escritório em outros segmentos do Direito.',
        'cta_text': 'Solicitar avaliação',
        'wa_text': 'Olá, Dr. Henrique. Preciso de orientação criminal.',
        'intro': {
            'h2': 'Criminal exige <em>análise técnica</em> antes de qualquer atuação.',
            'paragraphs': [
                'O Direito Criminal é uma das áreas <strong>mais delicadas</strong> da advocacia. Cada caso traz consigo riscos específicos — prisão preventiva, antecedentes, repercussão familiar — que exigem estratégia desde a primeira hora. Atuação reativa quase sempre custa caro.',
                'Por isso, no escritório, atendemos casos criminais de forma <strong>seletiva</strong>: priorizamos clientes que já estão sob nossa assessoria em outras áreas (trabalhista, empresarial, família) e cuja demanda criminal mantém continuidade. Para os demais, fazemos análise prévia e indicamos especialistas de confiança quando o caso fugir do nosso escopo.',
                'A primeira <strong>análise técnica</strong> é gratuita. Em até 48h retornamos com diagnóstico e indicação de caminhos.',
            ],
        },
        'bullets_eye': 'Em que atuamos',
        'bullets_h2': 'Frentes <em>criminais</em> que conduzimos.',
        'bullets': [
            {'title': 'Crimes patrimoniais', 'text': 'Apropriação indébita, estelionato, furto, receptação. Análise estratégica de provas e tese de defesa.'},
            {'title': 'Crimes contra a honra', 'text': 'Calúnia, injúria e difamação — especialmente em redes sociais. Resposta criminal e cumulação com indenização cível.'},
            {'title': 'Crimes ambientais e empresariais', 'text': 'Defesa de gestores e empresas em crimes de poluição, contra a ordem econômica, sonegação fiscal e responsabilidade ambiental.'},
            {'title': 'Lei de Drogas (Lei 11.343)', 'text': 'Análise de tráfico vs uso, pedido de desclassificação para uso, primariedade e penas alternativas.'},
            {'title': 'Crimes de trânsito', 'text': 'Embriaguez ao volante, lesão culposa, homicídio culposo no trânsito. Defesa em ação criminal e administrativa (Detran).'},
            {'title': 'Habeas Corpus e medidas urgentes', 'text': 'Atuação de urgência em prisão preventiva, prisão temporária, medidas cautelares e excessos no inquérito.'},
        ],
        'faq': [
            {'q': 'Por que o escritório atende criminal de forma seletiva?', 'a': 'Casos criminais demandam dedicação intensa e descontínua (urgências de madrugada, deslocamentos a delegacias). Optamos por <strong>volume controlado</strong> para garantir qualidade. Priorizamos clientes do portfólio em outras áreas — uma forma de manter a relação sem comprometer a estratégia.'},
            {'q': 'Não sou cliente em outra área. Vocês não atendem?', 'a': 'Avaliamos caso a caso. Se for matéria que dominamos e cabe na agenda, sim. Senão, indicamos <strong>advogados criminalistas de confiança</strong> em PE — sem custo de indicação.'},
            {'q': 'Quanto custa uma defesa criminal?', 'a': 'Honorários variam pelo grau (delegacia, JECRIM, juizado, vara criminal, tribunal) e complexidade. <strong>Sempre por escrito antes de qualquer ato</strong>. Temos parcelamento e contrato fixo para casos longos.'},
            {'q': 'Fui chamado pra depor na delegacia. Preciso ir?', 'a': 'Depende do tipo de oitiva. Como <strong>testemunha</strong>, pode ser obrigatório. Como <strong>investigado</strong>, você tem direito ao silêncio e à presença de advogado. Antes de ir, fale com um defensor.'},
            {'q': 'Atendem em emergência (pessoa presa)?', 'a': 'Sim para clientes do portfólio. Para terceiros, depende da disponibilidade. <strong>Tempo é crítico</strong> em prisão — quanto antes a defesa atuar, melhor o resultado.'},
        ],
    },
    ...
    'tributario': {
        'slug': 'tributario',
        'nav': 'tributario',
        'related_category': 'tributario',
        'page_title': 'Advogado Tributário em PE · Execuções Fiscais e Planejamento · Henrique Silva',
        'page_description': 'Defesa em execuções fiscais, planejamento tributário, parcelamentos, exclusões da base de cálculo e repetição de indébito. Atendimento técnico em Pernambuco.',
        'eyebrow': 'Direito Tributário',
        'h1': 'Direito <em>Tributário</em> · defesa, planejamento e recuperação.',
        'subtitle': 'Execuções fiscais, planejamento tributário, parcelamentos, exclusões da base de cálculo e repetição de indébito. Foco em redução legítima de carga.',
        'cta_text': 'Solicitar avaliação tributária',
        'wa_text': 'Olá, Dr. Henrique. Tenho uma questão tributária e gostaria de conversar.',
        'intro': {
            'h2': 'Tributário é onde o <em>conhecimento técnico</em> mais paga a si mesmo.',
            'paragraphs': [
                'Empresas brasileiras pagam, em média, <strong>33% do faturamento em tributos</strong>. Boa parte disso vem de cobranças indevidas: tributos sobre tributos, bases de cálculo infladas, créditos não aproveitados. Quem ignora, paga. Quem entende, recupera.',
                'Atuamos em <strong>defesa</strong> (execuções fiscais, autuações, multas), <strong>planejamento</strong> (estrutura societária, regime tributário, sucessão) e <strong>recuperação</strong> (repetição de indébito, exclusão de tributos da base, créditos não aproveitados).',
                'A análise inicial é <strong>gratuita</strong>: traga balancetes, autuações ou notificações pelo WhatsApp ou e-mail.',
            ],
        },
        'bullets_eye': 'Áreas tributárias',
        'bullets_h2': 'Onde podemos <em>atuar</em>.',
        'bullets': [
            {'title': 'Execuções fiscais', 'text': 'Defesa contra cobranças da União, estados e municípios. Embargos, exceção de pré-executividade, parcelamentos com suspensão.'},
            {'title': 'Repetição de indébito', 'text': 'Recuperação de tributos pagos a maior nos últimos 5 anos. Exclusão do ICMS da base do PIS/COFINS, IRPJ sobre Selic, INSS sobre verbas indenizatórias.'},
            {'title': 'Planejamento tributário', 'text': 'Análise de regime (Simples, Lucro Presumido, Lucro Real), estruturas societárias, sucessão patrimonial e holdings familiares.'},
            {'title': 'Multas e autuações', 'text': 'Defesa administrativa e judicial contra multas fiscais, glosas de créditos, lançamentos de oficio e fiscalizações arbitrárias.'},
            {'title': 'Parcelamentos especiais', 'text': 'Adesão a programas de regularização (Refis, transação tributária, parcelamentos ordinários e simplificados).'},
            {'title': 'Holdings e sucessão', 'text': 'Estruturação de holdings familiares para reduzir ITCMD e organizar sucessão patrimonial. Planejamento à luz da nova reforma tributária.'},
        ],
        'faq': [
            {'q': 'Recebi execução fiscal. O que fazer?', 'a': 'Tem <strong>5 dias</strong> para pagar ou garantir o juízo (depósito, fiança, penhora). Em paralelo, é possível ingressar com <strong>exceção de pré-executividade</strong> (sem garantia) ou <strong>embargos</strong> (com garantia). Mande a CDA pelo WhatsApp que analisamos.'},
            {'q': 'Posso recuperar PIS/COFINS pagos com ICMS na base?', 'a': 'Sim — desde a "tese do século" julgada pelo STF (RE 574.706), o ICMS não compõe a base do PIS/COFINS. Empresas têm direito a <strong>recuperar 5 anos retroativos</strong>. Análise por amostra pra definir se vale a pena.'},
            {'q': 'Vale migrar do Simples pro Lucro Presumido?', 'a': 'Depende. Empresas com margem alta e poucos funcionários costumam pagar mais no Simples do que no Presumido. <strong>Análise prévia é essencial</strong> — fazemos com base nos balancetes recentes.'},
            {'q': 'Holding familiar reduz ITCMD na herança?', 'a': 'Sim, em PE — <strong>de 8% sobre os bens para 4% sobre as quotas</strong>. Mas exige estruturação correta com 2-3 anos de antecedência. Análise prévia indica viabilidade.'},
            {'q': 'Quanto custa um trabalho tributário?', 'a': 'Em <strong>recuperação de indébito</strong>, trabalhamos por êxito — percentual sobre o que recuperarmos. Em <strong>planejamento e defesa</strong>, valor fixo definido após diagnóstico inicial. Sem custo inicial em recuperação.'},
        ],
    },
